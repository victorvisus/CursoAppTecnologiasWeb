...
BEGIN
	...
	SET email := LOWER(CONCAT(nombre, SUBSTRING(apellido1, 1, 3), SUBSTRING(apellido2, 1, 3), '@', dominio));
END;
$$
...
BEGIN
	...
	UPDATE alumno SET email = @email WHERE id = id;
END
$$

DELIMITER ;
INSERT INTO alumno VALUES (40, 'Andrés', 'García', 'Beltrán', 7.25);
INSERT INTO alumno VALUES (50, 'Lucía', 'Méndez', 'Castro', -2);
INSERT INTO alumno VALUES (60, 'Ramón', 'Núñez', 'Ortega', 10);